# data = open('Chapter_2\\TB2_Input_files\\rosalind_ba2d.txt').read()
data = open("D:\\IIT Madras\\Course material\\Bioinfo_coursera\\Bioinformatics_1\\1_Week_3\\dataset_30305_5.txt").read()
...
# with open('Chapter_2\\TB2_Output_files\\BA2D_output.txt', 'w') as f:
#         f.write(output)
with open("D:\\IIT Madras\\Course material\\Bioinfo_coursera\\Bioinformatics_1\\1_Week_3\\dataset_30305_5_output.txt", 'w') as f:
         f.write(output)